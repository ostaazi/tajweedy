// app/quiz/result/QuizResultClient.js - Client Component (كل المنطق + QR الجديد)
'use client';
...
// QR Code Component (الكود الذي قدمته)
...
export default function QuizResultClient() {
  ...
  // URL للـ QR (يحتوي على attemptId)
  const qrValue = attemptId ? `${typeof window !== 'undefined' ? window.location.origin : ''}/quiz/result?id=${attemptId}` : '';
        ...
        <div id="result-content" className="max-w-4xl mx-auto">
          ...
          {qrValue && (
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 text-center page-break-after">
              ...
              />
              <p className="text-gray-600 text-sm">امسح للوصول السريع إلى نتيجة الاختبار</p>
            </div>
          )}
